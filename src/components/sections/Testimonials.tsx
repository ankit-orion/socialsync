  ...
  return (
    <section className="bg-[#e8e8e8] py-16 md:py-24 overflow-hidden">
      <div className="text-center mb-14">
        ...
        <h2 className="text-3xl md:text-4xl font-black text-[#0d0d0d] tracking-tight">
          Don't take our word for it.
        </h2>
      </div>

      <div className="relative w-full flex overflow-hidden">
        <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#e8e8e8] to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#e8e8e8] to-transparent z-10 pointer-events-none" />
        <motion.div
        ...
        >
          {duplicated.map((review, i) => (
            <div key={i} className="w-[320px] md:w-[400px] shrink-0 p-7 rounded-[24px] bg-white border border-[#0d0d0d]/[0.06] hover:shadow-md transition-shadow duration-300">

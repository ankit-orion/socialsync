...
function FaqItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div
      className="border-b border-[#0d0d0d]/[0.08] py-6 pr-4 cursor-pointer group"
      onClick={() => setIsOpen(!isOpen)}
    >
      <div className="flex justify-between items-center gap-4">
        <h3 className="font-bold text-left text-[#0d0d0d] text-base md:text-lg group-hover:text-[#0d0d0d] transition-colors">
          {question}
        </h3>
        <ChevronDown
          className={`w-5 h-5 shrink-0 transition-transform duration-300 ${
            isOpen ? "rotate-180 text-[#0d0d0d]" : "text-[#0d0d0d]/30 group-hover:text-[#0d0d0d]"
          }`}
        />
      </div>
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <p className="pt-4 text-[#0d0d0d]/50 text-left leading-relaxed font-medium text-sm">
              {answer}
            </p>
          </motion.div>
        )}
    ...
    <main className="flex-1 w-full bg-[#e8e8e8] pt-28 pb-20 overflow-x-hidden">
      <div className="max-w-6xl mx-auto px-5 md:px-8 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            <div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#0d0d0d] tracking-tight leading-[1.05] mb-5">
                Let's scale
                <br />
                your brand.
              </h1>
              <p className="text-[#0d0d0d]/45 text-base md:text-lg font-medium leading-relaxed max-w-md">
                Book a free 30-minute discovery call with our growth team. No pressure, no commitment — just real strategy.
              </p>
            </div>

            {/* What happens */}
            <div className="bg-white rounded-[24px] border border-[#0d0d0d]/[0.05] p-7 shadow-[0_8px_30px_-10px_rgba(0,0,0,0.04)]">
              <h3 className="text-base font-black text-[#0d0d0d] mb-5 uppercase tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
              <div className="flex items-center gap-2 bg-white rounded-full px-4 py-2.5 border border-[#0d0d0d]/[0.05] shadow-sm">
                <Clock className="w-4 h-4 text-[#0d0d0d]/30" />
                <span className="text-sm font-bold text-[#0d0d0d]/60">30 Minutes</span>
              </div>
              <div className="flex items-center gap-2 bg-white rounded-full px-4 py-2.5 border border-[#0d0d0d]/[0.05] shadow-sm">
                <Video className="w-4 h-4 text-[#0d0d0d]/30" />
                <span className="text-sm font-bold text-[#0d0d0d]/60">Phone or Video</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white rounded-[28px] border border-[#0d0d0d]/[0.05] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] p-6 md:p-8"
          >
            {success ? (
              <div className="text-center py-12">
                ...
                <p className="text-base font-bold text-[#0d0d0d] mb-4">
                ...
                <p className="text-[#0d0d0d]/40 font-medium text-sm">
              ...
              <>
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-black text-[#0d0d0d] tracking-tight">
                    Pick a Time
                  </h3>
                  <p className="text-sm text-[#0d0d0d]/35 mt-2 font-medium">
                      ...
                      return (
                        <div
                          ...
                          className={`min-w-[72px] shrink-0 snap-start p-3 rounded-2xl border flex flex-col items-center justify-center cursor-pointer transition-all duration-200 ${
                            isSelected
                              ? "bg-[#0d0d0d] border-[#0d0d0d] shadow-lg scale-[1.03]"
                              : "bg-[#f7f7f8] border-[#0d0d0d]/[0.04] hover:border-[#0d0d0d]/[0.15]"
                          }`}
                        >
                          <span
                            className={`text-[10px] font-bold uppercase tracking-wider ${
                              isSelected ? "text-white/50" : "text-[#0d0d0d]/30"
                            }`}
                          >
                            {dayString}
                          </span>
                    ...
                    return (
                      <button
                        ...
                        className={`w-full py-3.5 px-5 rounded-2xl border flex justify-between items-center transition-all duration-200 ${
                          isSelected
                            ? "border-[#0d0d0d] bg-[#0d0d0d]/[0.03] ring-1 ring-[#0d0d0d]"
                            : "border-[#0d0d0d]/[0.06] bg-[#f7f7f8] hover:border-[#0d0d0d]/[0.15]"
                        }`}
                      >
                        <span
                          className={`font-bold text-sm ${
                            isSelected ? "text-[#0d0d0d]" : "text-[#0d0d0d]/45"
                          }`}
                        >
                          {time}
                        </span>
        ...
        >
            ...
            >
              <div className="inline-flex items-center gap-2 bg-white border border-[#0d0d0d]/[0.08] rounded-full px-4 py-2 shadow-sm">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                  <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" stroke="#0d0d0d" strokeWidth="2" strokeLinecap="round"/>
                  <polyline points="22 4 12 14.01 9 11.01" stroke="#0d0d0d" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span className="text-[11px] font-bold text-[#0d0d0d] tracking-wide uppercase">Process</span>
              </div>
            </motion.div>
            <h2 className="text-3xl md:text-4xl font-black text-[#0d0d0d] tracking-tight mb-4">
              What happens next?
            </h2>
            <p className="text-[#0d0d0d]/40 font-medium text-sm max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            {/* Connector line */}
            <div className="hidden md:block absolute top-[40px] left-[18%] right-[18%] h-[2px] bg-[#0d0d0d]/[0.06] -z-0" />
            ...
            {[
              {
                ...
                icon: (
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                    <circle cx="11" cy="11" r="8" stroke="#0d0d0d" strokeWidth="2" />
                    <line x1="21" y1="21" x2="16.65" y2="16.65" stroke="#0d0d0d" strokeWidth="2" strokeLinecap="round" />
                  </svg>
                ),
              },
              {
                ...
                icon: (
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                    <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" stroke="#0d0d0d" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                ),
              },
              {
                ...
                icon: (
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                    <line x1="18" y1="20" x2="18" y2="10" stroke="#0d0d0d" strokeWidth="2" strokeLinecap="round" />
                    <line x1="12" y1="20" x2="12" y2="4" stroke="#0d0d0d" strokeWidth="2" strokeLinecap="round" />
                    <line x1="6" y1="20" x2="6" y2="14" stroke="#0d0d0d" strokeWidth="2" strokeLinecap="round" />
                  </svg>
                ),
              },
            ].map((step, i) => (
              ...
              >
                ...
                <h4 className="text-lg font-black text-[#0d0d0d] tracking-tight mt-1 mb-3">
                  {step.title}
                </h4>
                <p className="text-[#0d0d0d]/40 text-sm font-medium leading-relaxed max-w-[220px] mx-auto">
                  {step.desc}
                </p>
              </motion.div>
            ))}
        ...
        >
          <div className="text-center mb-14">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-white border border-[#0d0d0d]/[0.08] rounded-full px-4 py-2 shadow-sm">
                ...
                <span className="text-[11px] font-bold text-[#0d0d0d] tracking-wide uppercase">FAQ</span>
              </div>
            </motion.div>
            <h2 className="text-3xl md:text-4xl font-black text-[#0d0d0d] tracking-tight mb-4">
          ...
          <div className="flex flex-col bg-white rounded-[24px] border border-[#0d0d0d]/[0.05] px-7 shadow-[0_8px_30px_-10px_rgba(0,0,0,0.04)]">
            <FaqItem
